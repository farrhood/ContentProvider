package ninja.farhood.contentprovider;
...
public class CustomContentProvider extends ContentProvider {
    ...
    static final String PROVIDER_NAME = "ninja.farhood.provider";
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (mUriMatcher.match(uri)) {
            case NICKNAME:
                ...
                break;
            case NICKNAME_ID:
                count = mDatabase.update(TABLE_NAME, values,
                        ID + " =" + uri.getLastPathSegment() + (!TextUtils.isEmpty(selection) ? "AND(" + selection + ')' : ""), selectionArgs);
                break;
            default:
    ...
    // class that creates and manages the provider's mDatabase
    private static class DBHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.w(DBHelper.class.getName(),
                    "Upgrading mDatabase from version " + oldVersion + "to" + newVersion + ".Old data will be destroyed");
